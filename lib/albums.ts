...
Till you hear it from the outside`,
    ...
    annotations: [
      { lyricText: "She had a product nobody would buy", note: "April Dunford was assigned a product conceived as a 'Microsoft Access killer' that supported SQL on desktops. After a significant marketing effort, they had barely sold 200 copies. The exec team was ready to wind it down entirely.", sourceTitle: "A quickstart guide to positioning", sourceUrl: "https://www.lennysnewsletter.com/p/positioning" },
      { lyricText: "\"Sorry, lady, we don't have that\"", note: "When April called customers, the first 20 conversations were identical. She'd say she was calling about their product; they'd reply 'Sorry, lady, we don't have that.' She'd insist they paid $100 for it, and they'd say 'Oh, that thing — yeah, we tried it, we don't use it now.'", sourceTitle: "A quickstart guide to positioning", sourceUrl: "https://www.lennysnewsletter.com/p/positioning" },
      { lyricText: "Then twenty-one picked up and blew her mind", note: "Out of 100 customers April called, 94 didn't even know they had the product. But 6 had transformed their business with it. Customer #21 used it on mobile devices for field sales, syncing with SQL back at HQ. One said: 'We're doubling sales! That SQL feature was a game changer!' Another reported 60% increased service capacity.", sourceTitle: "A quickstart guide to positioning", sourceUrl: "https://www.lennysnewsletter.com/p/positioning" },
      { lyricText: "Forty percent won't choose your rival's name", note: "April explains that in B2B sales, companies lose about 40% of deals to 'No decision' — meaning the real competitor isn't another product but the status quo: spreadsheets, pen and paper, or doing nothing. She says most founders dangerously discount this silent competitor.", sourceTitle: "April Dunford on product positioning, segmentation, and optimizing your sales process", sourceUrl: "https://www.lennyspodcast.com/april-dunford-on-product-positioning-segmentation-and-optimizing-your-sales-process/" },
      { lyricText: "Same code inside, she didn't change a thing", note: "They repositioned their 'Microsoft Access killer' as an 'embeddable database for mobile devices' — same product, zero code changes. The product took off. A year of massive growth later they were acquired, and the product spawned a family generating hundreds of millions in revenue. Over 20 years later, it still runs on mobile devices worldwide.", sourceTitle: "A quickstart guide to positioning", sourceUrl: "https://www.lennysnewsletter.com/p/positioning" },
    ],
  },
  {
...
Some fires just keep you warm`,
    ...
    annotations: [
      { lyricText: "She closed my deck at slide eleven", note: "Jason Fried told Lenny that 'basically almost nobody makes it' the venture route, and that there's 'a lot more room to make it, and to build a successful business, if you throw out that outlier.' VCs routinely pass on businesses that don't fit the unicorn model, no matter how strong the product or team.", sourceTitle: "Jason Fried challenges your thinking on fundraising, goals, growth, and more", sourceUrl: "https://www.lennyspodcast.com/jason-fried-challenges-your-thinking-on-fundraising-goals-growth-and-more/" },
      { lyricText: "But the users stayed, the revenue's real", note: "37signals has no investors, no board, and never plans to go public or sell. They've made a profit for 24 consecutive years, have over 100,000 customers, and make tens of millions in profit each year — which, as Lenny noted, 'most VC-backed companies never make a dollar of.'", sourceTitle: "Jason Fried challenges your thinking on fundraising, goals, growth, and more", sourceUrl: "https://www.lennyspodcast.com/jason-fried-challenges-your-thinking-on-fundraising-goals-growth-and-more/" },
      { lyricText: "Every board meeting moved the line", note: "Jason Fried explained that competitors like Slack (2,500 employees), Smartsheet (3,000), and Monday (1,500) are 'focused on growth' while 37signals runs about 70 employees focused on efficiency. All that VC-backed profit filters to investors — at 37signals, it all goes to founders and employees because they have none.", sourceTitle: "Jason Fried challenges your thinking on fundraising, goals, growth, and more", sourceUrl: "https://www.lennyspodcast.com/jason-fried-challenges-your-thinking-on-fundraising-goals-growth-and-more/" },
      { lyricText: "Patrick kept it all — two hundred mil", note: "Patrick Campbell bootstrapped ProfitWell and sold it for over $200 million without ever raising a round. But even he admitted to Lenny: 'This was a big mistake. If we had taken money, we could have had a billion-dollar exit or we could have kept going.' Even the biggest bootstrap success story wonders what was left on the table.", sourceTitle: "10 lessons on bootstrapping a $200m business | Patrick Campbell (ProfitWell)", sourceUrl: "https://www.lennyspodcast.com/10-lessons-on-bootstrapping-a-200m-business-patrick-campbell-profitwell/" },
      { lyricText: "Not every fire needs to be the sun", note: "Fried told Lenny: 'The reason I think it's great for entrepreneurs to start bootstrapping is because they just have more practice making money, and they get better and better at the fundamental skill you need to have ultimately to run a successful business, which is to make money.' The bootstrapping path isn't lesser — it's just different.", sourceTitle: "Jason Fried challenges your thinking on fundraising, goals, growth, and more", sourceUrl: "https://www.lennyspodcast.com/jason-fried-challenges-your-thinking-on-fundraising-goals-growth-and-more/" },
    ],
  },
  {
...
I'll be here next Tuesday though`,
    ...
    annotations: [
      { lyricText: "Someone asks me how it's going", note: "Gustaf Alstromer told Lenny: 'When you ask a founder the question, \"How are things going?\", it's so emotional for them to answer that question because it's never going well. They might say that, but everybody knows — all founders, when they look each other in the eyes, then no, that's not the answer.'", sourceTitle: "Lessons from working with 600+ YC startups | Gustaf Alstromer (Y Combinator, Airbnb)", sourceUrl: "https://www.lennyspodcast.com/lessons-from-working-with-600-yc-startups-gustaf-alstromer-y-combinator-airbnb/" },
      { lyricText: "Gustaf says forget your pitch", note: "Gustaf is a group partner at Y Combinator where he's worked with over 600 companies. Before YC, he spent over four years at Airbnb where he started the original growth team. In YC Group Office Hours, he asks founders 'Why are you doing this?' — not the market niche, but 'Why will you come in and work late after four years when you have no money left and everything's going to shit?'", sourceTitle: "Lessons from working with 600+ YC startups | Gustaf Alstromer (Y Combinator, Airbnb)", sourceUrl: "https://www.lennyspodcast.com/lessons-from-working-with-600-yc-startups-gustaf-alstromer-y-combinator-airbnb/" },
      { lyricText: "Six strangers in a ring", note: "Gustaf explained that starting a company is incredibly lonely: 'You can't really lean on your employees and say, \"Hey, I'm feeling really shitty as a founder today.\" Employees aren't going to take that well. You lean on perhaps your investors, but they're not really available. But what you can lean on is other founders because they're all in the same situation.'", sourceTitle: "Lessons from working with 600+ YC startups | Gustaf Alstromer (Y Combinator, Airbnb)", sourceUrl: "https://www.lennyspodcast.com/lessons-from-working-with-600-yc-startups-gustaf-alstromer-y-combinator-airbnb/" },
      { lyricText: "\"Mine is broken too\" — those words set me free", note: "Gustaf described how YC Group Office Hours work: 'We put all the founders in a group together in a room and they started learning that all founders, all companies are broken in some way. They're all having these massive problems and they're all feeling that anxiety. Just hearing other founders explain their problems is a really good way for yourself to both feel motivated and see how problems get solved.'", sourceTitle: "Lessons from working with 600+ YC startups | Gustaf Alstromer (Y Combinator, Airbnb)", sourceUrl: "https://www.lennyspodcast.com/lessons-from-working-with-600-yc-startups-gustaf-alstromer-y-combinator-airbnb/" },
      { lyricText: "I'll be here next Tuesday though", note: "YC groups companies together that have the same problems or operate in the same area, creating accountability alongside vulnerability. Gustaf noted that the second thing Group Office Hours do well is accountability — they ask 'What did you do this week?' This weekly rhythm of showing up, being honest, and pushing forward is what the song's final line captures.", sourceTitle: "Lessons from working with 600+ YC startups | Gustaf Alstromer (Y Combinator, Airbnb)", sourceUrl: "https://www.lennyspodcast.com/lessons-from-working-with-600-yc-startups-gustaf-alstromer-y-combinator-airbnb/" },
    ],
  },
  {
    slug: "seven-powers",
