...
That's taste`,
    concept: "Based on Shreyas Doshi's live episode on taste and product leadership, and Scott Belsky's rule: 'In the first 30 seconds, your user is lazy, vain, and selfish.' Taste is recognizing what's great before the results prove it — game recognize game.",
    keyInsight: "Taste is the ability to identify what is really good, without needing to see its results. It's built through exposure, not born.",
    sources: [
      { title: "Shreyas Doshi on taste and product leadership", type: "podcast", url: "https://www.lennysnewsletter.com/p/shreyas-doshi-live", guest: "Shreyas Doshi" },
      ...
      { title: "Lessons on building product sense, navigating AI, optimizing the first mile, and making it through the messy middle", type: "podcast" as const, url: "https://www.lennysnewsletter.com/p/scott-belsky", guest: "Scott Belsky" },
    ],
    ...
    storyBehind: "Shreyas Doshi told Lenny at a live summit that taste isn't about pixels or aesthetics — it's about the beliefs you choose to hold as a product leader. He asked himself 'Do I actually have good taste?' and realized it meant identifying what's great before results prove it: 'Game recognize game, before the game is called.' Scott Belsky added another dimension: 'In the first 30 seconds, your user is lazy, vain, and selfish.' The best product people combine both — the judgment to see what's right and the empathy to feel what's wrong.",
    annotations: [
      {
      ...
      },
      {
        ...
        note: "A recurring theme across Lenny's archive: the best product people combine pattern recognition (seeing what worked before) with genuine empathy (feeling what users feel). Shreyas Doshi told Lenny that taste is 'the ability to identify what is really good, without needing to see its results' — pattern recognition compressed into instinct.",
        sourceTitle: "Shreyas Doshi on taste and product leadership",
        sourceUrl: "https://www.lennysnewsletter.com/p/shreyas-doshi-live",
      },
      {
        lyricText: "Taste is saying no to good ideas",
        note: "A widely held product principle — often attributed to Steve Jobs — that resonates throughout Lenny's archive. The hardest part of taste isn't generating ideas; it's killing good ones to make room for great ones. Shreyas Doshi extended this on Lenny's podcast: taste isn't just about product aesthetics, it's about the beliefs you choose to hold as a leader.",
        sourceTitle: "Shreyas Doshi on taste and product leadership",
        sourceUrl: "https://www.lennysnewsletter.com/p/shreyas-doshi-live",
      },
      {
        lyricText: "The metrics miss the human pain",
        note: "A core theme across Lenny's archive: metrics capture behavior but miss emotion. Scott Belsky described this tension on the podcast — in the first 30 seconds users are 'lazy, vain, and selfish,' which no dashboard captures. The best PMs feel what data can't measure.",
        sourceTitle: "Scott Belsky on product sense and the first mile",
        sourceUrl: "https://www.lennysnewsletter.com/p/scott-belsky",
      },
    ],
...
Then prayed to process till it lost its heart`,
    ...
    sources: [
      ...
      { title: "Sanchan Saxena on the inside story of how Airbnb made it through Covid", type: "podcast" as const, url: "https://www.lennysnewsletter.com/p/sanchan-saxena-vp-of-product-at-coinbase", guest: "Sanchan Saxena" },
      { title: "Brian Chesky's secret mentor | Chip Conley", type: "podcast" as const, url: "https://www.lennysnewsletter.com/p/chip-conley", guest: "Chip Conley" },
    ],
...
Physically go to them`,
    ...
    sources: [
      ...
      { title: "Brian Chesky's contrarian approach to building Airbnb", type: "podcast" as const, url: "https://www.lennysnewsletter.com/p/brian-cheskys-contrarian-approach", guest: "Brian Chesky" },
    ],
